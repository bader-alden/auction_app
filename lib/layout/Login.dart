                                      ...
                                      children: [
                                        ...
                                        Center(
                                          child: ElevatedButton(
                                            ...
                                            child: Container(height: 40,width: MediaQuery.of(context).size.width/1.5,child: Center(child:
                                            is_loading
                                            ?SizedBox(height: 20,width: 20,child: Center(child: CircularProgressIndicator(color: Colors.white),))
                                            :Text(is_login ? "تسجيل دخول":"إنشاء حساب",style: const TextStyle(fontSize: 20),))),
                                          ),
                                        ),
                                        const SizedBox(height: 10,),
                                        Row(
